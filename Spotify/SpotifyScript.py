...
client_id = '8c7b7084215c4cf589c9693bba61e8c7'
client_secret = '6b8dcfa10d4c4ca5a89c293cfdf118b4'
...
for i, row in df_spotify.iterrows():
    ...
    if track_id:
        ...
        df_spotify.at[i, 'image_url'] = image_url  # Assign inside the conditional block
    else:
        df_spotify.at[i, 'image_url'] = None  # Handle the case where track_id is None

##Save the updated DataFrame (replace 'updated_file.csv' with your desired output file name)
df_spotify.to_csv('updated-spotify-2023.csv', index=False)